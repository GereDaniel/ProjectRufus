...
string[] enemyNames = { "Gorlock", "Maru", "Bober", "Pigwin", "Bob", "József", "Fereng", "Vojtech", "Topegi", "Kirby" };
...
void Battle(string type)
{
    ...
    int enemyHeatlh = rng.Next(1, 200);
...
{
    Color[] cTable = cColors.Select(x => Color.FromArgb(x)).ToArray();y
